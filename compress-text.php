...
<div class="container fade-in">
  <div class="card-style">
    <h3 class="mb-4">COMPRESS TEXT FILE</h3>

    <form action="compress-action.php" method="post" enctype="multipart/form-data" onsubmit="setLoadingState()">
      <div class="upload-area mb-4" id="uploadArea">
        <i class="bi bi-cloud-upload-fill fs-1"></i>
        <p id="file-name" class="mt-3">Click or Drag & Drop file here</p>
        <input type="file" name="textfile" id="fileInput" class="file-input" accept=".txt" required>
      </div>

      <div class="row justify-content-center mb-3">
        <div class="col-md-4 d-flex justify-content-center">
          <button type="submit" id="startButton" class="btn btn-outline-danger">
            <i class="bi bi-rocket-takeoff-fill me-2"></i> Start
          </button>
        </div>
      </div>
    </form>
...
<script>
  ...
  function setLoadingState() {
    ...
    startButton.innerHTML = '<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span> Compressing...';
  }
</script>
